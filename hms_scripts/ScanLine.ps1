...
# Remote app should be published as powershell.exe and require argument c:\users\public\documents\ScanLine.ps1
...
Start-Process -FilePath 'c:\Program Files (x86)\IQMS\IQWin32\ScanLine.exe';