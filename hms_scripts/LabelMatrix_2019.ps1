...
# Remote app should be published as powershell.exe and require argument c:\users\public\documents\LabelMatrix_2019.ps1
...
Set-Location "C:\Program Files (x86)\LABEL MATRIX 2019"
Start-Process -FilePath "C:\Program Files (x86)\LABEL MATRIX 2019\lmw.exe" -Verbose
