...
Start-Sleep 10; 
cd 'C:\Program Files (x86)\Global Software Inc\Spreadsheet Server\Query Designer\'; 
Start-Process -FilePath 'C:\Program Files (x86)\Global Software Inc\Spreadsheet Server\Query Designer\QueryDesigner.exe';