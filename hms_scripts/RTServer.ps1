...
# Remote app should be published as powershell.exe and require argument c:\users\public\documents\RTServer.ps1
...
if ($iqalert) {
    ...
    Start-Process -FilePath 'c:\Program Files (x86)\IQMS\IQWin32\RTServer.exe';
}
