...
Start-Sleep 5; 
cd 'C:\Program Files (x86)\Crystal Reports Viewer\SAP Crystal Reports viewer\'; 
Start-Process -FilePath 'C:\Program Files (x86)\Crystal Reports Viewer\SAP Crystal Reports viewer\CrystalReportsViewer.exe';