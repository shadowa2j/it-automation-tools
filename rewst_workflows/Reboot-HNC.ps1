<#
.SYNOPSIS
    Triggers a Rewst webhook to reboot HNC device.

.DESCRIPTION
    Calls the specified Rewst webhook endpoint to reboot HNC (Device ID: 3329).
...
try {
    Write-Host "Calling Rewst webhook to reboot HNC (Device ID: $deviceId)..." -ForegroundColor Cyan
    ...
    Write-Host "  HNC reboot initiated." -ForegroundColor Green
